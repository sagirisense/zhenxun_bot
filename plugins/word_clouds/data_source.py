...
async def draw_word_cloud(messages, config):
    ...
    if not os.listdir(wordcloud_dir):
        url = "https://mirror.ghproxy.com/https://raw.githubusercontent.com/HibiKier/zhenxun_bot/main/resources/image/wordcloud/default.png"
        try:
    ...
    if not wordcloud_ttf.exists():
        ttf_url = "https://mirror.ghproxy.com/https://raw.githubusercontent.com/HibiKier/zhenxun_bot/main/resources/font/STKAITI.TTF"
        try:
